...
Source0  : https://files.pythonhosted.org/packages/6a/95/01db50116d85cd4604b570c370a3b718de99ac44c95d3ee27a753f7ff02a/virtualenv-20.11.2.tar.gz
...
%prep
%setup -q -n virtualenv-20.11.2
cd %{_builddir}/virtualenv-20.11.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640795178
...
cp %{_builddir}/virtualenv-20.11.2/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
