...
Version  : 20.0.17
Release  : 98
URL      : https://files.pythonhosted.org/packages/1c/fc/1bcbb524de8cef189166e7e42c31f411ace373ceacdd77d9a366d13976c6/virtualenv-20.0.17.tar.gz
Source0  : https://files.pythonhosted.org/packages/1c/fc/1bcbb524de8cef189166e7e42c31f411ace373ceacdd77d9a366d13976c6/virtualenv-20.0.17.tar.gz
...
%prep
%setup -q -n virtualenv-20.0.17
cd %{_builddir}/virtualenv-20.0.17
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586480508
...
cp %{_builddir}/virtualenv-20.0.17/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
