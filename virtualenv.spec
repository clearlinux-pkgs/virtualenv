...
Version  : 20.0.12
Release  : 93
URL      : https://files.pythonhosted.org/packages/1e/34/50bc510a411d9faf156467a3b7e4cb34a0a128e09c747c15dd92c46895cc/virtualenv-20.0.12.tar.gz
Source0  : https://files.pythonhosted.org/packages/1e/34/50bc510a411d9faf156467a3b7e4cb34a0a128e09c747c15dd92c46895cc/virtualenv-20.0.12.tar.gz
...
%prep
%setup -q -n virtualenv-20.0.12
cd %{_builddir}/virtualenv-20.0.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584638230
...
cp %{_builddir}/virtualenv-20.0.12/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
