...
Source0  : https://files.pythonhosted.org/packages/e0/75/9310506a1b9f93016cdf4e34dd802521477508abc6626b93129d412fe187/virtualenv-20.4.6.tar.gz
...
%prep
%setup -q -n virtualenv-20.4.6
cd %{_builddir}/virtualenv-20.4.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620316115
...
cp %{_builddir}/virtualenv-20.4.6/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
