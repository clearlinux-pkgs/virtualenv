...
Version  : 20.0.16
Release  : 97
URL      : https://files.pythonhosted.org/packages/ba/d7/8bc2730e8b0505c699880f7ee48515eb22a53f443ebeaad78c92f1949673/virtualenv-20.0.16.tar.gz
...
%prep
%setup -q -n virtualenv-20.0.16
cd %{_builddir}/virtualenv-20.0.16
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586278620
...
cp %{_builddir}/virtualenv-20.0.16/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
