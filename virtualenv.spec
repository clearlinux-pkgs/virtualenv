...
Source0  : https://files.pythonhosted.org/packages/85/3e/6c3abf78b2207f3565ebadd0b99d1945f4ff18abdc6879617a4f6d939e41/virtualenv-20.0.33.tar.gz
...
%prep
%setup -q -n virtualenv-20.0.33
cd %{_builddir}/virtualenv-20.0.33
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601952735
...
cp %{_builddir}/virtualenv-20.0.33/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
