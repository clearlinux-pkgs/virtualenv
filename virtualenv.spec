...
Version  : 20.0.11
Release  : 92
URL      : https://files.pythonhosted.org/packages/0e/9a/722eb55ec3406ffc29c285317343af4d59a136448695fece4f878b272f36/virtualenv-20.0.11.tar.gz
Source0  : https://files.pythonhosted.org/packages/0e/9a/722eb55ec3406ffc29c285317343af4d59a136448695fece4f878b272f36/virtualenv-20.0.11.tar.gz
...
%prep
%setup -q -n virtualenv-20.0.11
cd %{_builddir}/virtualenv-20.0.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584592271
...
cp %{_builddir}/virtualenv-20.0.11/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
