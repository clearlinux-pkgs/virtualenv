...
Version  : 20.0.24
Release  : 103
URL      : https://files.pythonhosted.org/packages/cd/a4/dddac5fa6af5d51f85e253c6a2938100beca56fd7a47b4e366b7916966d5/virtualenv-20.0.24.tar.gz
Source0  : https://files.pythonhosted.org/packages/cd/a4/dddac5fa6af5d51f85e253c6a2938100beca56fd7a47b4e366b7916966d5/virtualenv-20.0.24.tar.gz
...
%prep
%setup -q -n virtualenv-20.0.24
cd %{_builddir}/virtualenv-20.0.24
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592855932
...
cp %{_builddir}/virtualenv-20.0.24/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
