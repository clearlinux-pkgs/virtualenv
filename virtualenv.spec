...
Source0  : https://files.pythonhosted.org/packages/54/a2/bbfd87f524096f26b373a3428e56bdcda6661ba38314f1d864a71a6e70ce/virtualenv-20.0.18.tar.gz
...
%prep
%setup -q -n virtualenv-20.0.18
cd %{_builddir}/virtualenv-20.0.18
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587062797
...
cp %{_builddir}/virtualenv-20.0.18/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
