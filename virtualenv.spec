...
%prep
%setup -q -n virtualenv-20.4.2
cd %{_builddir}/virtualenv-20.4.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612201189
...
cp %{_builddir}/virtualenv-20.4.2/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
