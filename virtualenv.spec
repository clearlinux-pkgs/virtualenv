...
Version  : 20.4.5
Release  : 131
URL      : https://files.pythonhosted.org/packages/c0/a0/35793751e2f54be6edd9227892bf66cf8a75d228330a7db5e45e8dc46143/virtualenv-20.4.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/c0/a0/35793751e2f54be6edd9227892bf66cf8a75d228330a7db5e45e8dc46143/virtualenv-20.4.5.tar.gz
...
%prep
%setup -q -n virtualenv-20.4.5
cd %{_builddir}/virtualenv-20.4.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620227271
...
cp %{_builddir}/virtualenv-20.4.5/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
