...
Source0  : https://files.pythonhosted.org/packages/05/fd/b5de62edd29d4e25f7b93bfe41857bdf69aa07f8f4a03340180456d6320a/virtualenv-20.0.8.tar.gz
...
%prep
%setup -q -n virtualenv-20.0.8
cd %{_builddir}/virtualenv-20.0.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583529611
...
cp %{_builddir}/virtualenv-20.0.8/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
