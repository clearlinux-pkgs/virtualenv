...
%prep
%setup -q -n virtualenv-16.7.9
cd %{_builddir}/virtualenv-16.7.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576538852
...
cp %{_builddir}/virtualenv-16.7.9/LICENSE.txt %{buildroot}/usr/share/package-licenses/virtualenv/2e754399255de49ca03cd159799837bf3b94f1ff
