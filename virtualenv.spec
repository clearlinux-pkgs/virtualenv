...
Source0  : https://files.pythonhosted.org/packages/f4/6d/bfcfff1709d05143e71337db4800b30dd9abf0c41972960c9e8984ab96f7/virtualenv-20.4.3.tar.gz
...
%prep
%setup -q -n virtualenv-20.4.3
cd %{_builddir}/virtualenv-20.4.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615910804
...
cp %{_builddir}/virtualenv-20.4.3/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
