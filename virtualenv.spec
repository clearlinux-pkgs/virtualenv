...
Source0  : https://files.pythonhosted.org/packages/91/37/cfff3b23392ae6a774f4cb7ed22c00566cdc50ee25b6305480cf48f1741c/virtualenv-20.7.1.tar.gz
...
%prep
%setup -q -n virtualenv-20.7.1
cd %{_builddir}/virtualenv-20.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628535438
...
cp %{_builddir}/virtualenv-20.7.1/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
