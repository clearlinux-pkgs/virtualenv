...
Source0  : https://files.pythonhosted.org/packages/dd/40/9bc1b32521f78c293c1f8ca423c725737dfa9d09640dbeec61cebca7c5f2/virtualenv-20.8.1.tar.gz
...
%prep
%setup -q -n virtualenv-20.8.1
cd %{_builddir}/virtualenv-20.8.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632508202
...
cp %{_builddir}/virtualenv-20.8.1/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
