...
Source0  : https://files.pythonhosted.org/packages/6d/89/9691b0d0521c069bd238585ccb7f4035b8393d843a50491270e7dae0209e/virtualenv-20.7.2.tar.gz
...
%prep
%setup -q -n virtualenv-20.7.2
cd %{_builddir}/virtualenv-20.7.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628700991
...
cp %{_builddir}/virtualenv-20.7.2/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
