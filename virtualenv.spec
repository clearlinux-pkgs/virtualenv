...
Source0  : https://files.pythonhosted.org/packages/e8/fe/9700d24a5b315a5493966ef901636570c995bbe678f5a27eca4b393ad2e2/virtualenv-20.0.34.tar.gz
...
%prep
%setup -q -n virtualenv-20.0.34
cd %{_builddir}/virtualenv-20.0.34
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602526663
...
cp %{_builddir}/virtualenv-20.0.34/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
