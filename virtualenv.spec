...
Source0  : https://files.pythonhosted.org/packages/e2/04/878273c00ec63df9acf76d1657155243c8874ca38833c62eface20ce15cd/virtualenv-20.7.0.tar.gz
...
%prep
%setup -q -n virtualenv-20.7.0
cd %{_builddir}/virtualenv-20.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627929009
...
cp %{_builddir}/virtualenv-20.7.0/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
