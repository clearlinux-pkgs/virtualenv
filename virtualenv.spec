...
Source0  : https://files.pythonhosted.org/packages/60/5f/f17dd17ba9ee47fb0629789bbd320e833622634444877b2e7d90922aa0e5/virtualenv-20.0.5.tar.gz
...
%prep
%setup -q -n virtualenv-20.0.5
cd %{_builddir}/virtualenv-20.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582324887
...
cp %{_builddir}/virtualenv-20.0.5/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
