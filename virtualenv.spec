...
%prep
%setup -q -n virtualenv-20.0.27
cd %{_builddir}/virtualenv-20.0.27
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594867157
...
cp %{_builddir}/virtualenv-20.0.27/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
