...
Version  : 20.0.9
Release  : 90
URL      : https://files.pythonhosted.org/packages/de/8a/478771a9fb917c615ab2c29e9375468552ce326ec99836074ef18a12c23f/virtualenv-20.0.9.tar.gz
Source0  : https://files.pythonhosted.org/packages/de/8a/478771a9fb917c615ab2c29e9375468552ce326ec99836074ef18a12c23f/virtualenv-20.0.9.tar.gz
...
%prep
%setup -q -n virtualenv-20.0.9
cd %{_builddir}/virtualenv-20.0.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583773746
...
cp %{_builddir}/virtualenv-20.0.9/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
