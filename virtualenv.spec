...
Source0  : https://files.pythonhosted.org/packages/38/0a/1edcf3e106680167b4a2db90782c80c7910bcbfe79610921503d9cbe0d87/virtualenv-20.5.0.tar.gz
...
%prep
%setup -q -n virtualenv-20.5.0
cd %{_builddir}/virtualenv-20.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626194092
...
cp %{_builddir}/virtualenv-20.5.0/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
