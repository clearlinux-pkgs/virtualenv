...
Source0  : https://files.pythonhosted.org/packages/57/60/e31195bb422c2c6ecc52b456855eb6be7dc53a5df583e3628626fd8c5718/virtualenv-20.11.0.tar.gz
...
%prep
%setup -q -n virtualenv-20.11.0
cd %{_builddir}/virtualenv-20.11.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640711940
...
cp %{_builddir}/virtualenv-20.11.0/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
