...
Source0  : https://files.pythonhosted.org/packages/aa/08/2c6c5a295133bd8244d74ccd21e7b3008d0cc96bad29163b3fedbd7c3ffc/virtualenv-20.3.1.tar.gz
...
%prep
%setup -q -n virtualenv-20.3.1
cd %{_builddir}/virtualenv-20.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610558563
...
cp %{_builddir}/virtualenv-20.3.1/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
