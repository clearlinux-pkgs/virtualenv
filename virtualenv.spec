...
Source0  : https://files.pythonhosted.org/packages/86/90/0d30f9cea58b9589016ec5cc33eec6a077d31b0f9bce092e925e528f4802/virtualenv-20.0.32.tar.gz
...
%prep
%setup -q -n virtualenv-20.0.32
cd %{_builddir}/virtualenv-20.0.32
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601608029
...
cp %{_builddir}/virtualenv-20.0.32/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
