...
Source0  : https://files.pythonhosted.org/packages/8b/67/67e5dd2d1676c3fa8a67c707114325d713feadb7824d9aaf2396be5401d3/virtualenv-20.9.0.tar.gz
...
%prep
%setup -q -n virtualenv-20.9.0
cd %{_builddir}/virtualenv-20.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635119891
...
cp %{_builddir}/virtualenv-20.9.0/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
