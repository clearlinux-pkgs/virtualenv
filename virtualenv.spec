...
Source0  : https://files.pythonhosted.org/packages/d2/58/6afb5bd05c610e378eb8f1188896fd0a19dfe99d84613cdb60f2ca5cf0ef/virtualenv-20.0.25.tar.gz
...
%prep
%setup -q -n virtualenv-20.0.25
cd %{_builddir}/virtualenv-20.0.25
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592946925
...
cp %{_builddir}/virtualenv-20.0.25/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
