...
Source0  : https://files.pythonhosted.org/packages/e0/49/070b07f330d9680f509e63c0a1f6712afc31e503dca2976b49b6f02c282c/virtualenv-20.12.0.tar.gz
...
%prep
%setup -q -n virtualenv-20.12.0
cd %{_builddir}/virtualenv-20.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640978507
...
cp %{_builddir}/virtualenv-20.12.0/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
