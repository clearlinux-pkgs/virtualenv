...
Source0  : https://files.pythonhosted.org/packages/f7/01/2e69c5b190f8ec553eafcd8b1df9ed79233d9b09420ea71d0070ce9a8e6c/virtualenv-20.0.7.tar.gz
...
%prep
%setup -q -n virtualenv-20.0.7
cd %{_builddir}/virtualenv-20.0.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582747504
...
cp %{_builddir}/virtualenv-20.0.7/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
