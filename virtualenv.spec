...
Source0  : https://files.pythonhosted.org/packages/c4/1b/09bb751c6e805bf4711bbaead5499c8d8caf92398ba8da92daa8bf19f60e/virtualenv-20.0.26.tar.gz
...
%prep
%setup -q -n virtualenv-20.0.26
cd %{_builddir}/virtualenv-20.0.26
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594142881
...
cp %{_builddir}/virtualenv-20.0.26/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
