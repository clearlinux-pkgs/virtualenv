...
Source0  : https://files.pythonhosted.org/packages/f1/db/4498de0294f0c72a2e0a099d1588e7b55d0c849db740c89978ff73700519/virtualenv-20.13.0.tar.gz
...
%prep
%setup -q -n virtualenv-20.13.0
cd %{_builddir}/virtualenv-20.13.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641240360
...
cp %{_builddir}/virtualenv-20.13.0/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
