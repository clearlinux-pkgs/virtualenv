...
Source0  : https://files.pythonhosted.org/packages/45/cb/d381ee22c78dd8d34ded5e2d1f6856f93347c4c608a5b2fa9374393a1351/virtualenv-16.7.8.tar.gz
...
%prep
%setup -q -n virtualenv-16.7.8
cd %{_builddir}/virtualenv-16.7.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574460887
...
cp %{_builddir}/virtualenv-16.7.8/LICENSE.txt %{buildroot}/usr/share/package-licenses/virtualenv/2e754399255de49ca03cd159799837bf3b94f1ff
