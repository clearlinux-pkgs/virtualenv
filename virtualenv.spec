...
Source0  : https://files.pythonhosted.org/packages/15/cd/9bbb31845faec1e3848edcc4645411952a9a2a91a21c5c0fb6b84d929c5f/virtualenv-20.0.28.tar.gz
...
%prep
%setup -q -n virtualenv-20.0.28
cd %{_builddir}/virtualenv-20.0.28
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595606995
...
cp %{_builddir}/virtualenv-20.0.28/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
