...
Version  : 20.0.23
Release  : 102
URL      : https://files.pythonhosted.org/packages/a5/fb/b95b0ce5160296aa3b220574a5fc13f53250a4f6770c126ae968960b95db/virtualenv-20.0.23.tar.gz
...
%prep
%setup -q -n virtualenv-20.0.23
cd %{_builddir}/virtualenv-20.0.23
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592371429
...
cp %{_builddir}/virtualenv-20.0.23/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
