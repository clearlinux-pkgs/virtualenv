...
Source0  : https://files.pythonhosted.org/packages/ca/5d/c746f030903a75fd428851560f2895a16a5065ed53a69c232c4beb0eafb4/virtualenv-20.4.4.tar.gz
...
%prep
%setup -q -n virtualenv-20.4.4
cd %{_builddir}/virtualenv-20.4.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618931463
...
cp %{_builddir}/virtualenv-20.4.4/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
