...
Source0  : https://files.pythonhosted.org/packages/d0/b6/2c6da6a79279023c305c4b1d974daec075d5e59cddd88d820d136976ad8a/virtualenv-20.0.10.tar.gz
...
%prep
%setup -q -n virtualenv-20.0.10
cd %{_builddir}/virtualenv-20.0.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583870411
...
cp %{_builddir}/virtualenv-20.0.10/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
