...
Source0  : https://files.pythonhosted.org/packages/fb/f8/5a5fd05ee4b85b819bc7c11d287a32f6925a970fe2f867eac1889b8760ed/virtualenv-20.0.30.tar.gz
...
%prep
%setup -q -n virtualenv-20.0.30
cd %{_builddir}/virtualenv-20.0.30
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596643798
...
cp %{_builddir}/virtualenv-20.0.30/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
