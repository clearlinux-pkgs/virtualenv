...
Version  : 16.0.0
Release  : 50
URL      : http://pypi.debian.net/virtualenv/virtualenv-16.0.0.tar.gz
Source0  : http://pypi.debian.net/virtualenv/virtualenv-16.0.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1530987343
