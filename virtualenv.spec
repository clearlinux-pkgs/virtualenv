...
Source0  : https://files.pythonhosted.org/packages/28/a8/96e411bfe45092f8aeebc5c154b2f0892bd9ea462d6934b534c1ce7b7402/virtualenv-20.0.35.tar.gz
...
%prep
%setup -q -n virtualenv-20.0.35
cd %{_builddir}/virtualenv-20.0.35
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602778898
...
cp %{_builddir}/virtualenv-20.0.35/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
