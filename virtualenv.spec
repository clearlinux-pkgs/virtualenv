...
Source0  : https://files.pythonhosted.org/packages/d4/f9/e65670c81f7b6a4131fdb0ee42f2d5d4be42e89e6ffd04d4a43bd1c4ff8e/virtualenv-20.6.0.tar.gz
...
%prep
%setup -q -n virtualenv-20.6.0
cd %{_builddir}/virtualenv-20.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626366787
...
cp %{_builddir}/virtualenv-20.6.0/LICENSE %{buildroot}/usr/share/package-licenses/virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
